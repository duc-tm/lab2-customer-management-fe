...
<body>
  <div class="main">
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light fixed-top shadow-sm" id="navbar">
      <div class="container">
        <a class="navbar-brand fw-bolder" href="#">MARC</a>
    ...
    <div class="container mt-5" id="about-us">
      <div class="row">
        <h2 class="text-uppercase text-center mb-5">Vì sao chọn MARC</h2>
        <div class="col-md-7 mb-4">
          <img class="img-fluid" src="https://w.ladicdn.com/s1200x900/596486701663abf2d493432e/5-20210803034215.png" alt="">
        </div>
    ...
    <div class="container-fluid text-center mt-5" id="our-customer">
      ...
      <div class="container top-spending-customer mt-5">
        <h3 class="top-spending-customer__title mb-5 text-uppercase">Vinh danh khách hàng</h3>
        <div class="row">
          <?php
          $imgArr = [
